...
def star_coupler(
    ...
    for i, y in enumerate(y_positions_out):
        ...
        # Utiliser le taper du PDK SiEPIC UBC (L40um, 500nm->3000nm)
        taper = pdk_components.ebeam_routing_taper_te1550_w500nm_to_w3000nm_L40um()
